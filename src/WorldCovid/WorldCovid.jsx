...
import classes from './WorldCovid.module.css'
import {Dropdown, DropdownButton, Button} from 'react-bootstrap';
import axios from 'axios'
import { createPeriod, currentDate } from '../dataApi';
  ...
  return (
    <div className={classes.App}>
        <h2 style={{marginBlock: '10px'}}>
            {country}: Аналитика распростанения Covid-19
        </h2>
        <div>
        ...
        <div>
            ...
            <GraphAggregator country={country}/>
        </div>
    </div>
  )
}
